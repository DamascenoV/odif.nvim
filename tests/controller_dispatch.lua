...
local cases = {
  { '\27',  'abort' }, { '\3',   'abort' }, { '\r',   'choose' },
  { '\n',   'choose_literal' }, -- \n == <C-j>, fido literal
  { '\127', 'bs' },    { '\14',  'next' },
  { '\16',  'prev' },  { '\19',  'next' },  { '\18',  'prev' },
  { '\10',  'choose_literal' }, { '\4', 'choose_literal' },
  { '\21',  'clear' }, { '\23',  'word_back' },
  { 'a',    'insert' },{ 'Z',    'insert' },{ '/',    'insert' },
...
for _, c in ipairs(cases) do
  ...
  assert(got == want,
    ('classify(%q) = %s, want %s'):format(ch, got, want))
end
