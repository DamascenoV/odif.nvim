...
spawn.lines(
  { 'sh', '-c', 'printf "alpha\\nbeta\\ngamma\\n"' },
  function(lines) for _, l in ipairs(lines) do seen[#seen + 1] = l end end,
  function(code) exit_code = code; done = true end
)
...
assert(seen[1] == 'alpha' and seen[2] == 'beta' and seen[3] == 'gamma',
